...
class AdminController extends Controller
{
    ...
    {
        $routes = Route::orderBy('updated_at', 'desc')->get()->take(8);
        $vehicles = Vehicle::orderBy('created_at', 'desc')->get()->take(8);
        $cargos = Cargo::orderBy('created_at', 'desc')->get()->take(8);
        $drivers = User::orderBy('created_at', 'desc')->get()->take(8);
        $tools = Garage::orderBy('created_at', 'desc')->get()->take(8);
    ...
    public function vehicle(Request $request)
    {
        ...
        return view('admin.vehicle')->with('vehicles', $vehicle);
    }
    ...
    public function garages(Request $request)
    {
        ...
        return view('admin.garage')->with('garages', $garage);
    }
    ...
    public function driver(Request $request)
    {
        ...
        return view('admin.driver')->with('drivers', $drivers);
    }

    // Staff Members
    public function staff(Request $request)
    {
        $staffs = User::whereRoleIs(['superadmin', 'manager', 'muhasibu', 'storekeeper'])->orderBy('updated_at', 'desc')->paginate(20);
        ...
        if (!is_null($request->date)) {
            if (strlen($request->date) > 16) {
                ...
                if (!is_null($request->search)) {
                    ...
                    $staffs = User::orderBy('updated_at', 'desc')->whereRoleIs(['superadmin', 'manager', 'muhasibu', 'storekeeper'])
                        ->whereBetween('updated_at', [$fromdate, $toDate])
                        ->where('name', 'LIKE', '%' . $search . '%')
                        ->orWhere('fname', 'LIKE', '%' . $search . '%')
                        ->orWhere('lname', 'LIKE', '%' . $search . '%')
                    ...
                    $staffs = User::orderBy('updated_at', 'desc')
                        ->whereRoleIs(['superadmin', 'manager', 'muhasibu', 'storekeeper'])
                        ->whereBetween('updated_at', [$fromdate, $toDate])
                        ->paginate(15);
                }
            } else {
    ...
    public function cargos(Request $request)
    {
        ...
        return view('admin.cargo')->with('cargos', $cargos);
    }

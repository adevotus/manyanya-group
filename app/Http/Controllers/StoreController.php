...
class StoreController extends Controller
{
    ...
    {
        $routes = Route::orderBy('created_at', 'desc')->get()->take(4);
    ...
    public function vehicle(Request $request)
    {
        ...
        return view('store.vehicle')->with('vehicles', $vehicle);
    }
    ...
    public function garages(Request $request)
    {
        ...
        return view('store.garage')->with('garages', $garage);
    }
    ...
    public function driver(Request $request)
    {
        ...
        return view('store.driver')->with('drivers', $drivers);
    }
    ...
    public function cargos(Request $request)
    {
        ...
        return view('store.cargo')->with('cargos', $cargos);
    }
    ...
    public function routes(Request $request)
    {
        ...
        return view('store.routes')->with('routes', $routes)
            ->with('vehicles', $vehicles)
            ->with('drivers', $drivers)
            ->with('cargos', $cargos);
    }

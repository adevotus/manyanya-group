                    ...
                    datasets: [
                        {
                            ...
                            data: [
                                65, 59, 80, 81, 56, 89, 40, 32, 65, 59, 80, 81,
                            ],
                        },
                        {
                            label: "Dollar Rate",
                            ...
                            data: [
                                89, 40, 32, 65, 59, 80, 81, 56, 89, 40, 65, 59,
                            ],
                        },
                    ],
                };
                        ...
                        datasets: [
                            {
                                label: "Desktops",
                                backgroundColor: hexToRGB(
                                    (s = (i = d("#radar-chart-example").data(
                                        "colors"
                                    ))
                                        ? i.split(",")
                                        : r.concat())[0],

...
<head>
    ...
    <title>Yaronga Enterprise - Invoive Mail</title>
                                        ...
                                        <td class="content-block"
                                            ...
                                            <h2 class="aligncenter"
                                                ...
                                                {{-- <a href="#" style="display: block;margin-bottom: 10px;">
                                                    <img
                                                        src="../assets/images/logo-dark.png" height="24"
                                                        alt="logo" /></a> <br /> --}}
                                                Thanks for using Yaronga Entreprise
                                            </h2>
                                        </td>
                                    </tr>
                                    <tr
                                                        ...
                                                        <table class="invoice-items" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr
                                                                ...
                                                                <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; border-top-width: 1px; border-top-color: #eee; border-top-style: solid; margin: 0; padding: 5px 0;"
                                                                    valign="top">{{ $cargo_name }}
                                                                </td>
                                                                <td class="alignright"
                                                                    style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; text-align: right; border-top-width: 1px; border-top-color: #eee; border-top-style: solid; margin: 0; padding: 5px 0;"
                                                                    align="right" valign="top"> {{ $cargo_weight }}
                                                                </td>
                                                                <td class="alignright"
                                                                    style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; text-align: right; border-top-width: 1px; border-top-color: #eee; border-top-style: solid; margin: 0; padding: 5px 0;"
                                                                    align="right" valign="top">Tsh
                                                                    {{ number_format($cargo_price) }}
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>

                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form id="formData" action="{{ route('posts.create') }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="image" accept="image/*" id="simpleinput"
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-xl-12">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <img srcset="" id="imgShow" alt="image" height="400"
                                                            width="400" class="img-fluid rounded">
                                                    </div>
                                                </div>
                                            </div> <!-- end col-->
                                        </div>

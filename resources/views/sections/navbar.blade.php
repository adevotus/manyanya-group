    ...
    <nav
        ...
        <a href="/" class="navbar-brand bg-secondary d-flex align-items-center px-4 px-lg-5">
            <h3 class="mb-2 text-white text-break text-small" style="color:black;">Manyanya
                Enterprises
            </h3>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="text-center text-secondary p-3 mr-2  text-black"
                ...
                <a href="{{ route('login') }}" type="button" class="text-uppercase  p-2"
                    style="font-size: small; color: #51CFED !important;">
                    Staff Only <i class="fas fa-sign-in-alt"></i></a>
            </div>
        </div>
    </nav>
    <!-- Navbar End -->

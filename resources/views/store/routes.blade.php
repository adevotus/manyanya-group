                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <div class="me-3">
                                    <form action="{{ route('store.routes') }}" method="get">
                                    ...
                                    @if ($routes && $routes->count() > 0)
                                        @foreach ($routes as $key => $route)
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge @if ($route->status === 'delivered') bg-soft-success text-success @elseif ($route->status === 'pending')  bg-soft-warning text-warning @else bg-soft-danger text-danger @endif">
                                                        {{ $route->status }}
                                                    </span>
                                                </td>
                                                <td>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <form method="POST" action="{{ route('store.routes') }}">
                        @csrf
